    ...
    <div className="grid lg:grid-cols-12 min-h-screen text-[14px]">
        ...
        <div className="lg:col-span-6 flex justify-center items-center">
            <Card className="p-8 bg-white rounded-[16px] min-w-[430px] flex flex-col items-center gap-3 shadow-md border-none">
                ...
                {success && <div className='bg-[#33ec5b] text-white p-2 rounded-md'>{success}</div>}

                {!success && (
                    <div className='bg-[#a12424] text-white p-2 rounded-md'>{error}</div>
                )}

                <Link href="/auth/login" className=''>Back to Login</Link>
