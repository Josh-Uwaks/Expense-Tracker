...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="md:min-h-[150vh] flex flex-col items-center py-0 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  scale-[0.55] mb-[550px] md:mb-0 sm:scale-50"
    >
      <motion.h2
        style={{
